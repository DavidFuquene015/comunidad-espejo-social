...
const CreateRideOffer = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Oferta creada",
        description: "Tu oferta de viaje ha sido publicada exitosamente.",
      });
      ...
      toast({
        title: "Error",
        description: error.message || "No se pudo crear la oferta de viaje.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <p className="text-muted-foreground">
              Debes iniciar sesión para crear una oferta de viaje.
            </p>
          </CardContent>
        </Card>
      </div>
  ...
  return (
    <div className="container mx-auto p-6 max-w-2xl">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold mb-2">Ofrecer Viaje</h1>
        <p className="text-muted-foreground">
          Comparte tu vehículo y ayuda a otros estudiantes a llegar al SENA.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Proporciona los detalles de tu viaje disponible
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Ej: Chevrolet Spark Azul, Placa ABC123"
                />
              </div>
